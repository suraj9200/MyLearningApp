    ...
    render() {
        ...
        return (
            <Line
                x={this.props.x}
                y={this.props.y}
                points={[this.props.points[0].px1, this.props.points[0].py1, this.props.points[0].px2, this.props.points[0].py2, this.props.points[0].px3, this.props.points[0].py3]}
                stroke={'blue'}
